...
def main():
    ...
    win = glfw.create_window(
        WIN_W, WIN_H,
        "2D Translation + Rotation (Composite)",
        None, None
    )
    ...
    glLoadIdentity()
    glOrtho(-2, 8, -2, 8, -1, 1)  # Extend viewport for transformed triangle
    ...
    # ---------------- COMPOSITE MATRIX ----------------
    # Apply rotation AFTER translation: Composite = R × T
    Composite = R @ T
    ...
    print("\nTranslation Matrix:\n", T)
    print("\nRotation Matrix (60° anticlockwise):\n", R)
    print("\nComposite Transformation Matrix (R × T):\n", Composite)
